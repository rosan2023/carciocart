        ...
        <Fragment>
            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around">
                        ...
                        <Carousel pause="hover">
                            {product.images && product.images.length > 0 && product.images.map(image =>
                                <Carousel.Item key={image._id}>
                                    <img className="d-block w-100"  src={image.image} alt={product.name} height="500" width="600" />
                                </Carousel.Item>
                            )}
                        </Carousel>
                    </div>
                    ...
                    <hr/>
                    <p>Mfg Year : <strong> {product.mfgyear}</strong> First Registration Year : <strong> {product.fregyear} </strong></p>
                    <hr/>
                    <p>Color : <strong>{product.color} </strong> No.Of Doors: <strong> {product.noofdoors} </strong>  No of Auto Doors: <strong> {product.noofautodoors} </strong> </p>
                    <hr/>
                    <p>Engine CC: <strong> {product.engincapacity} </strong> Fuel Type: <strong>{product.oiltype} </strong>  Gear Type: <strong>{product.geartype}</strong></p>
